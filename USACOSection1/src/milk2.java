...
public class milk2 {
	  public static void main (String [] args) throws IOException {
		  ...
		  if(timespans.length == 1) longestNotMilked = 0;
		  for(int i = 0 ; i < timespans.length-1; i++){
			  int notMilked = timespans[i+1].start - timespans[i].end; 
			  longestNotMilked = notMilked > longestNotMilked ? notMilked : longestNotMilked;
		  }
...
class TimeSpanComparator implements Comparator<TimeSpan>{
